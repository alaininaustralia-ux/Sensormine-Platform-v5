...
export const dashboardApi = {
   ...
   */
  async list(userId: string, tenantId?: string): Promise<DashboardDto[]> {
   ...
   */
  async get(id: string, userId: string, tenantId?: string): Promise<DashboardDto | null> {
    const effectiveTenantId = tenantId || getCurrentTenantId();
    try {
   ...
   */
  async getRoots(userId: string, tenantId?: string): Promise<DashboardDto[]> {
    const effectiveTenantId = tenantId || getCurrentTenantId();
    try {
   ...
   */
  async getSubPages(parentId: string, tenantId?: string): Promise<DashboardDto[]> {
    const effectiveTenantId = tenantId || getCurrentTenantId();
    try {
