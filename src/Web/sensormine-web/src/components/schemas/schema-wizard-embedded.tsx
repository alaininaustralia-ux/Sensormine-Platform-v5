/**
 * Schema Wizard Embedded Component
 * 
 * Embedded version of schema wizard for use in modals/dialogs
 * No navigation, optimized for inline creation
 */
...
import type { CreateSchemaRequest, Schema } from '@/lib/types/schema';
...
interface SchemaWizardEmbeddedProps {
  onSuccess?: (schema: Schema) => void;
  onCancel?: () => void;
}

export function SchemaWizardEmbedded({ onSuccess, onCancel }: SchemaWizardEmbeddedProps) {
